...
class ObjManager:
    ...
    def __call__(self, request):
        ...
        return '200 OK', render('obj_manager.html', categories_list=mapper.all(),
...
class ObjectsList:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            mapper = MapperRegistry.get_current_mapper('category')
            category = mapper.find_by_id((int(request['request_params']['id'])))
    ...
    def __call__(self, request):
        if request['method'] == 'POST':
            ...
            if self.category_id != -1:
                ...
                mapper = MapperRegistry.get_current_mapper('category')
                category = mapper.find_by_id(int(self.category_id))
